		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="<?= base_url();?>Common/addTransporter" type="button" class="btn btn-primary btn-large"><i class="fas fa-bus"></i>&nbsp;New Transport/Bowser</a>
			...
			<!--<h4 class="page-title">Add Transport/Bowser</h4>-->
			<!--<ol class="breadcrumb">-->
			<!--	<li class="breadcrumb-item"><a href="javascript:void(0);">Transport/Bowser</a></li>-->
			<!--	<li class="breadcrumb-item active">Add Transport/Bowser</li>-->
			<!--</ol>-->
...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				<form method="post" action="<?= base_url('Common/addTransporter');?>">
				<div class="row">
				<div class="col-lg-12">
				...
				<div class="col-lg-12">
					<div class="mt-3">
						...
						<button type="submit" class="col-sm-2 btn btn-successs">Proceed</button>
					</div>
				</div>
