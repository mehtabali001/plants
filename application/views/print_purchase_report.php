                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="detail text-left" >
                                                     <span style="font-weight:bold;">&nbsp;Type:</span>&nbsp;<span class="" style="">Purchase Report</span><br>
                                                     <span style="font-weight:bold;">&nbsp;Showing Report As:</span>&nbsp;<span style=""><?php echo str_replace('_', ' ', $_GET['filter']); ?>, <?php if($_GET['type']==1){echo 'Detailed';}else{echo 'Summary';} ?> </span> <br>
                                                     <span style="font-weight:bold;">&nbsp;From:</span>&nbsp;<span class="fromDate" style=""><?//php echo $_GET['form']; ?></span><br>
                                                     <span style="font-weight:bold;">&nbsp;To:</span>&nbsp;<span class="toDate" style=""><?//php echo $_GET['to']; ?></span>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
