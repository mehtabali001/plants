		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Common/addLocation" type="button" class="btn btn-primary btn-large"><i class="fa fa-shopping-cart"></i>&nbsp;New Warehouse/Location</a>
...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				<form method="post" action="<?= base_url('Common/addLocation');?>">
				<div class="row">
				<div class="col-lg-12">
				    ...
				    <div class="row">
				        <div class="col-lg-6">
            				<div class="mt-3">
            						...
            						<input type="text" class="form-control"  name="fld_location" id="fld_location" required placeholder="e.g Durnal Plant" pattern=".*\S+.*">
            					</div>
            				</div>
        				    <div class="col-lg-6">
            					<div class="mt-3">
            						...
            						<input type="text" class="form-control"  name="fld_address" id="fld_address" required placeholder="e.g Chakwal Road Durnal" pattern=".*\S+.*">
            					</div>                      
            				</div>
        			</div>
        			<br>
