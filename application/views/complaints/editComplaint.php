	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<div class="col-sm-3">
					<div class="form-group row">
						<label for="supplier_sss" class="col-sm-4 col-form-label">Subject <i class="text-danger">*</i>
						</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="complain_subject" id="complain_subject"   value="<?= $complaint['fld_complain_subject']?>" required tabindex="1" placeholder="Repair Machine">
						</div>
				 ...
				 <div class="col-sm-5">
					<div class="form-group row">
						<label for="supplier_sss" class="col-sm-3 col-form-label">Category <i class="text-danger">*</i>
						</label>
						<div class="col-sm-7">
							<select class="form-control" name="comp_category" id="comp_category" tabindex="2" required>
				...
				<div class="col-sm-12">
					<div class="form-group row">
						...
						<div class="col-sm-11">
							<textarea class="form-control" rows="5" name="complain_description" id="complain_description"  required tabindex="3" placeholder="Please repair the machine" ><?= $complaint['fld_description']?></textarea>
						</div>
