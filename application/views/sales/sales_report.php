		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Sales/manage_drafts" type="button" class="btn btn-outline-primary"><i class="fa fa-vcard"></i>&nbsp;Drafts</a>
                  <a href="<?= base_url();?>Sales/purchReport" type="button" class="btn btn-primary btn-large"><i class="fa fa-bar-chart"></i>&nbsp;Sale Report</a>
                </div>
			</div>
		...
		<div class="card">
			<div class="card-body">
				...
				<form id="saleFilter" >
						...
						<? if(!empty($role_permissions) && in_array(273,$role_permissions)) { ?>
						<div class="row">
						<div class="col-sm-12">
						  <div class="float-right" style="margin-bottom: 15px;">
                            <button type="button" id="currentday" class="btn btn-success waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(45 218 181 / 50%);" name="show-current-day" onclick="getSaleFilterDataByDate('daily');"><i class="fa fa-line-chart" aria-hidden="true"></i>&nbsp;This Day</button>
                            <button type="button" id="currentweek" class="btn btn-purple waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(109 129 245 / 50%);" name="show-current-week" onclick="getSaleFilterDataByDate('weekly');"><i class="fa fa-line-chart" aria-hidden="true"></i>&nbsp;This Week</button>
                            <button type="button" id="currentmonth" class="btn btn-secondary waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(65 203 216 / 50%) !important;" name="show-current-month" onclick="getSaleFilterDataByDate('monthly');"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;This Month</button>
                            <button type="button" id="currentyear" class="btn btn-info waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(155 167 202 / 50%);" name="show-current-year" onclick="getSaleFilterDataByDate('yearly');"><i class="fa fa-line-chart" aria-hidden="true"></i>&nbsp;This Year</button>
						   </div>
						</div>
						</div>
						<? } ?>
                        ...
                        <button type="button" id="show_report" class="btn btn-successs btn-large show_report" name="show-report" onclick="getSalereport();"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Proceed F10</button>
                        ...
                        <button type="button" id="reset_filters" class="btn btn-danger" name="" value="" disabled onclick="window.location.href='<?= base_url(); ?>Sales/salesReport'"><i class="fa fa-refresh" aria-hidden="true" ></i>&nbsp;Reset F5</button>
...
<script>
   function downloadcsv(){
       ...
       var formdata=$('#saleFilter').serialize();
       window.location.href="<?php echo base_url(); ?>Sales/salesReport_csv?"+formdata;
   }
</script>