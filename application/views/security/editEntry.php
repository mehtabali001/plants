	...
	<div class="col-lg-12">
		<div class="card" style="overflow:auto;">
			<div class="card-body">
				...
				<form method="post" id="myform" action="<?= base_url('Entries/editprocess');?>" enctype="multipart/form-data">
				<div class="row">
				<div class="col-lg-12">
				<?php 
				...
				<div class="col-lg-12">
				    <div class="mt-3">
					   ...
					   <input type="text" class="form-control datepicker" name="entry_date" id="entry_date" value="<?= date('d/m/Y',strtotime($entry['entry_date']))?>" required>	
                    </div>
                    <div class="mt-3">
						...
						<select class="select2 form-control mb-3 custom-select" id="fld_vehicle" name="fld_vehicle" required="required">
							...
							?>
							<option value="<?= $veh['fld_id'];?>" data_driver="<?= $veh['fld_dname1'];?>" <? if($entry['fld_vehicle'] == $veh['fld_id']){ echo "selected"; } ?>><?= $veh['fld_vehicle_number'];?></option>
							<?php } } ?>
						</select>
					</div>
					<div class="mt-3">
						<label class="mb-2">Driver <i class="text-danger">*</i></label>
					    <input type="text" name="driver" id="driver_name" placeholder="Driver Name" class="form-control" value="<? echo $entry['driver']; ?>" required />
					</div>
				</div> 
				<div class="col-lg-6">
				    <div class="mt-3">
                        <label for="in-time-input" class="mb-2">In Time <i class="text-danger">*</i></label>
                        <input class="form-control" name="in_time" type="time" id="in-time-input"  value="<? echo $entry['in_time']; ?>" required>
                    </div>
				</div>
				<div class="col-lg-6">
				    <div class="mt-3">
                        <label for="out-time-input" class="mb-2">Out Time </label>
                        <input class="form-control" name="out_time" type="time"  value="<? echo $entry['out_time']; ?>" id="out-time-input">
                    </div>
				</div>
				<div class="col-lg-6">
                  <div class="row">
                    <div class="col-md-6" style="margin-top: 8%;">
                      <input class="form-control" name="fld_id" type="hidden" value="<? echo $entry['fld_id']; ?>">
