		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
    			<div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="<?= base_url();?>Accounts/chequepaidvoucher" type="button" class="btn btn-outline-primary"><i class="fa fa-shopping-cart"></i>&nbsp;New Cheque Paid Voucher</a>
                  <a href="<?= base_url();?>Vouchers/cashreceivevoucher" type="button" class="btn btn-primary btn-large"><i class="fa fa-vcard"></i>&nbsp;New Cash Recieve Voucher</a>
			...
			<!--<h4 class="page-title">Cash Receive Voucher</h4>-->
			<!--<ol class="breadcrumb">-->
			<!--	<li class="breadcrumb-item"><a href="javascript:void(0);">Vouchers</a></li>-->
			<!--	<li class="breadcrumb-item active">Cash Receive Voucher</li>-->
			<!--</ol>-->
		...
		<div class="card">
			<div class="card-body">
			    ...
			    <div class="col-lg-12">
				 ...
				 <form id="addPurchase" action="<?= base_url('Vouchers/cashreceivevoucher');?>" onsubmit="onsubmitform();" class="form-vertical"  method="post" >
						<div class="row">
						<div class="col-sm-6">
							<h4 class="form-section"><i class="icon-eye6"></i>Cash Receive Voucher</h4>
						</div>
						<div class="col-sm-6">
							...
							<select class="select2 form-control mb-3 custom-select"  name="jv_voucher_history" id="jv_voucher_history" style="width:100%;">
								<option value="">CRV History</option>
								<?php if($crv_voucher){
								foreach($crv_voucher as $voucher){	
								?>
                        ...
                        <div class="row">
						    ...
						    <div class="col-sm-4">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
										<input type="text" readonly class="form-control" name="fld_voucher_no" placeholder="Voucher Number" id="fld_voucher_no" value="CRV-<?php echo $maxid;?>">
                                    </div>
                                </div> 
                            </div>
                            ...
                            <div class="col-sm-4">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
										<input type="text" readonly class="form-control" name="fld_type" placeholder="Voucher Type" id="fld_type" value="CRV">
                                    </div>
                                </div> 
                            </div>
                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tbody id="voucher_details">
                                    ...
                                    <tr>
                                        ...
                                        <td class="test">
                                            <input type="number" step="0.01" oninput="validity.valid||(value='');"  name="amount[]" required="" readonly  id="amount_<?=$sn;?>" class="form-control amount text-right" onkeyup="calculateSum()" onchange="calculateSum()" placeholder="0.00" value="<?=$vData['credit'];?>" min="0" required>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="test">
                                            <input type="number" step="0.01" oninput="validity.valid||(value='');"  name="amount[]" required=""   id="amount_<?=$sn;?>" class="form-control amount text-right" onkeyup="calculateSum()" onchange="calculateSum()" placeholder="0.00" value="<?=$vData['credit'];?>" min="0" required>
                                        </td>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-8">
                                ...
                                <?php }else{ ?>
                                    ...
                                    <input type="submit" id="add_vourcher" class="btn btn-successs"  name="add-vourcher" value="Submit F10">
