		...
		<div class="page-title-box">
			<div class="float-right">
    			<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Vouchers/incomereport_items" type="button" class="btn btn-primary btn-large"><i class="fa fa-vcard"></i>&nbsp;Item-wise Income Report</a>
                  ...
                  <a href="<?= base_url();?>Accounts/incomereport" type="button" class="btn btn-outline-primary"><i class="fa fa-bar-chart"></i>&nbsp;Income Report</a>
                </div>
			</div>
			<h4 class="page-title">Item-Wise Income Report</h4>
			<ol class="breadcrumb">
		...
		<div class="card">
			<div class="card-body">
				...
				<form id="ledgerFilter" >
						...
						<div class="col-sm-12">
							<h4 class="form-section"><i class="icon-eye6"></i>Items Income Report</h4>
						</div>
                        ...
                        <div class="row" style="">
                            ...
                            <div class="col-sm-3">
    							<select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" onchange="enableShowButton(this.value);" name="item_type" id="item_type" required>
                        ...
                        <div class="col-sm-12">
                        <button type="button" id="show_report" class="btn btn-primary btn-large show_report" name="show-report" value="" onclick="getItemIncomeReport();" disabled><i class="fa fa-search" aria-hidden="true" ></i>&nbsp;Show Report</button>
                        
                        
                        <button type="button" style="margin: 0px 10px;background-color: DodgerBlue;" id="print_report" onclick="printPdfItemIncomeReport(1);" class="btn  print_report" name="" value="" disabled><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print Report</button>
					
                        <button type="button" style="margin: 0px 10px;" id="pdf_purchase_report" class="btn btn-gradient-pink pdf_purchase_report" onclick="printPdfItemIncomeReport(2);" name="" value="" disabled><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;Download PDF</button>
						
                        <button type="button" style="margin: 0px 10px;" id="reset_filters" class="btn btn-danger" name="" value="" disabled onclick="window.location.href='<?= base_url(); ?>Accounts/incomereport_items'"><i class="fa fa-refresh" aria-hidden="true" ></i>&nbsp;Reset Flters</button>
