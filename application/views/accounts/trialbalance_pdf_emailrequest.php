...
<td>
    <div class="detail " style="float:right;margin-top: 4%;" >
        <span style="font-weight:bold;">&nbsp;Type:</span>&nbsp;<span>Trial Balance Report</span><br>
         <span style="font-weight:bold;">&nbsp;From:</span>&nbsp;<span class="" style=""><?=$start_time;?></span><br>
         <span style="font-weight:bold;">&nbsp;To:</span>&nbsp;<span class="" style=""><?=$sending_time;?></span>
    </div>
</td>
</tr>
</tbody>
...
<table id="datatable_tb" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
	...
	<tbody class="ledgerRows" id="ledgerRows">
			...
			$balance = $this->db->query("SELECT IFNULL(SUM(a.debit), 0)-IFNULL(SUM(a.credit), 0) as balance FROM tbl_transections_details as a, tbl_transections_master as b WHERE b.id = a.v_id && b.date >= '$start_time' && b.date <= '$sending_time' && a.coa_id LIKE '{$account['head_code']}%'")->row()->balance;
			if($balance > 0){
			    $totalDebit += $balance;
			}else{
