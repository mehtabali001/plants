		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
    			<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Vouchers/cashpayementvoucher" type="button" class="btn btn-primary btn-large"><i class="fa fa-vcard"></i>&nbsp;New Cash Payment Voucher</a>
		...
		<div class="card">
			<div class="card-body">
			    ...
			    <div class="col-lg-12">
				 ...
				 <form id="addPurchase" action="<?= base_url('Vouchers/cashpayementvoucher');?>" onsubmit="onsubmitform();" class="form-vertical"  method="post" >
                        ...
                        <div class="row">
						    ...
						    <div class="col-sm-4">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
										<input type="text" readonly class="form-control" name="fld_voucher_no" placeholder="Voucher Number" id="fld_voucher_no" value="CPV-<?php echo $maxid;?>">
                                    </div>
                                </div> 
                            </div>
                            ...
                            <div class="col-sm-4">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
										<input type="text" readonly class="form-control" name="fld_type" placeholder="Voucher Type" id="fld_type" value="CPV">
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
									<select class="select2 form-control mb-3 custom-select " name="from_account" readonly id="from_account" onchange="getBalance(0, 0, this.value);" required>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    ...
                                    <label for="Account" class="col-sm-4 col-form-label">Account <i class="text-danger" id="f_balance">(Balance: <?=$this->CI->getBalanceInner($editDataV['coa_id'], $editDataV['credit']); ?>)</i></label>
                                    <div class="col-sm-8">
									<select class="select2 form-control mb-3 custom-select " name="from_account"  id="from_account" onchange="getBalance(0, 0, this.value);" required>
                                        <option value="">Select Account</option>
										<?php
										if($from_accounts){
										foreach($from_accounts as $account){
         ...
         <!--                   </div>-->
                 ...
                 <!--                           <div class="tooltip1 input-group-append">-->
    									    <!--    <button type="button" class="btn btn-gradient-secondary btn-clipboard" onclick="paste()"> Paste</button>-->
    									    <!--</div>-->
    									    <div class="input-group">
                                        ...
                                        <td class="test">
                                            <input type="number" step="0.01" oninput="validity.valid||(value='');"  name="amount[]" required="" readonly  id="amount_<?=$sn;?>" class="form-control amount text-right" onkeyup="calculateSum()" onchange="calculateSum()" placeholder="0.00" value="<?=$vData['debit'];?>" min="0" required>
                                        </td>
