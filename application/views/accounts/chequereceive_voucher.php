		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
    			<div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="<?= base_url();?>Vouchers/chequereceivevoucher" type="button" class="btn btn-primary btn-large"><i class="fa fa-shopping-cart"></i>&nbsp;Cheque Receive Voucher</a>
			...
			<!--	<li class="breadcrumb-item active">Cheque Receive Voucher</li>-->
			<!--</ol>-->
		...
		<div class="card">
			<div class="card-body">
			    ...
			    <div class="col-lg-12">
				 ...
				 <form id="addPurchase" action="<?= base_url('Vouchers/chequereceivevoucher');?>" onsubmit="onsubmitform();" class="form-vertical"  method="post" >
						
						<div class="row">
						<div class="col-sm-6">
							<h4 class="form-section"><i class="icon-eye6"></i>Cheque Receive Voucher</h4>
						</div>
						<div class="col-sm-6">
							...
							<select class="select2 form-control mb-3 custom-select" name="jv_voucher_history" id="jv_voucher_history" style="width:100%;">
								<option value="">CHRV History</option>
								<?php if($chrv_voucher){
								foreach($chrv_voucher as $voucher){	
								?>
                        ...
                        <div class="row">
						    ...
						    <div class="col-sm-4">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
										<input type="text" readonly class="form-control" name="fld_voucher_no" placeholder="Voucher Number" id="fld_voucher_no" value="CHRV-<?php echo $maxid;?>" tabindex="1">
                                    </div>
                                </div> 
                            </div>
                            ...
                            <div class="col-sm-4">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
										<input type="text" readonly class="form-control" name="fld_type" placeholder="Voucher Type" id="fld_type" value="CHRV" tabindex="2">
                                    </div>
                                </div> 
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
									    <?php if(isset($edit) && $edit != ""){ ?>
                                            <input type="text" required="" class="form-control" name="date" id="date" value="<?=date('d/m/Y', strtotime($editData['date']));?>" readonly tabindex="3">
                                        <?php }else{ ?>
									      <input type="text" required="" class="form-control datepicker" name="date" id="date" tabindex="3">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    <label for="Account" class="col-sm-4 col-form-label">Account <i class="text-danger" id="f_balance">(Balance: <?=$this->CI->getBalanceInner($editDataV['coa_id']); ?>)</i></label>
                                    <div class="col-sm-8">
									<select class="select2 form-control mb-3 custom-select " readonly name="from_account" id="from_account" onchange="getBalance(0, 0, this.value);" tabindex="4">
         ...
         <!--                           <div class="col-sm-10 input-group">-->
									<!--<input type="text" required="" class="form-control" name="from_narration" id="narration" placeholder="Paymet's nature and description" value="<?=$this->CI->getStringBetween($editDataV['narration']);?>" tabindex="5">-->
         ...
         <!--                           </div>-->
                            ...
                            <!--                <button type="button" class="btn btn-outline-light btn-sm btn-clipboard" onclick="myFunction()"  data-clipboard-action="copy" data-clipboard-target="#clipboardInput"><i class="far fa-copy"></i></button>-->
                            <!--                <button type="button" class="btn btn-outline-light btn-sm btn-clipboard"  onclick="paste2()"><i class="far fa-clipboard"></i></button>-->
                            <!--            </div>-->
                            <!--            </div>-->
                            <!--        </div>-->
                            <!--    </div>-->
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    <label for="Account" class="col-sm-4 col-form-label">Account <i class="text-danger" id="f_balance">(Balance: <?=$this->CI->getBalanceInner($editDataV['coa_id']); ?>)</i></label>
                                    <div class="col-sm-8">
									<select class="select2 form-control mb-3 custom-select "  name="from_account" id="from_account" onchange="getBalance(0, 0, this.value);" tabindex="4">
                                        <option value="">Select Account</option>
										<?php
										if($from_accounts){
										foreach($from_accounts as $account){
         ...
         <!--                           <div class="col-sm-10 input-group">-->
									<!--<input type="text" required="" class="form-control" name="from_narration" id="narration" placeholder="Paymet's nature and description" tabindex="5">-->
         <!--                           <div class="tooltip1 input-group-append">-->
									<!--        <button type="button" class="btn btn-gradient-secondary btn-clipboard" onclick="myFunction()" onmouseout="outFunc()" data-clipboard-action="copy" data-clipboard-target="#clipboardInput"><i class="far fa-copy mr-2"></i><span class="tooltiptext" id="myTooltip">Copy</span></button>-->
									<!--</div>-->
                                    <!--</div>-->
                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tbody id="voucher_details">
                                    ...
                                    foreach($editDataDetails as $vData){
                                        $sn++;
                                    $totalAmount += $vData['credit'];
                                    ?>
                                    <tr>
                                        <td class="span3">
                                           <input type="text" id="coa_id_<?=$sn;?>" name="coa_id[]" class="form-control text-center" placeholder="Code" value="<?=$vData['coa_id'];?>" readonly tabindex="6">
                                        </td>
                                        <td class="span3">
                                           <select class="select2 form-control mb-3 custom-select sel_account_id" readonly onchange="inputCode(<?=$sn;?>, this.value)" name="account_id" id="account_id_<?=$sn;?>" required style="width:100%;" tabindex="7">
                                                <option value="">Select Account</option>
                                                <?php
        										if($to_accounts){
                                        ...
                                        <td class="span3">
                                            <!--<input type="text" id="narration_<?=$sn;?>" name="narration[]" class="form-control text-left" tabindex="8" placeholder="Paymet's nature and description"  value="<?//= $this->CI->getStringBetween(str_replace('"',"",$vData['narration']));?>" required>-->
                                        <div class="input-group">
                                        ...
                                        <td class="span3">
                                           <input type="text" id="p_balance_<?=$sn;?>" name="p_balance[]" class="form-control text-center" tabindex="9" placeholder="0.00" value="<?=$this->CI->getBalanceInner($vData['coa_id']); ?>" readonly>
                                        </td>
                                        
                                        <td class="test">
                                            <input type="number" step="0.01" oninput="validity.valid||(value='');"  name="amount[]" required="" readonly  id="amount_<?=$sn;?>" class="form-control amount text-right" tabindex="10" onkeyup="calculateSum()" onchange="calculateSum()" placeholder="0.00" value="<?=$vData['credit'];?>" min="0" required>
                                        </td>
                                        
                                        <td>
                                            <button class="btn btn-danger text-right red" type="button" value="Delete" onclick="deleteRow(this)" tabindex="11" disabled><i class="fas fa-times"></i></button>
                                        </td>
                                    </tr>
                                    <?php }}else if(isset($duplicate)){
                                    foreach($editDataDetails as $vData){
                                    ...
                                    <tr>
                                        ...
                                        <td class="span3">
                                           <select class="select2 form-control mb-3 custom-select sel_account_id"  onchange="inputCode(<?=$sn;?>, this.value)" name="account_id" id="account_id_<?=$sn;?>" required style="width:100%;" tabindex="7">
                                                <option value="">Select Account</option>
                                                <?php
        										if($to_accounts){
        										foreach($to_accounts as $account){
                                        ...
                                        <td class="test">
                                            <input type="number" step="0.01" oninput="validity.valid||(value='');"  name="amount[]" required=""   id="amount_<?=$sn;?>" class="form-control amount text-right" tabindex="10" onkeyup="calculateSum()" onchange="calculateSum()" placeholder="0.00" value="<?=$vData['credit'];?>" min="0" required>
                                        </td>
                                        
                                        <td>
                                            <button class="btn btn-danger text-right red" type="button" value="Delete" onclick="deleteRow(this)" tabindex="11" ><i class="fas fa-times"></i></button>
                                        </td>
                                    </tr>
                                    <?php }}else{ ?>
                                    <tr>
                                        <td class="span3">
                                           <input type="text" id="coa_id_1" name="coa_id[]" class="form-control text-center"  tabindex="12"placeholder="Code" readonly>
                                        </td>
                                        <td class="span3">
                                           <select class="select2 form-control mb-3 custom-select sel_account_id"tabindex="13" onchange="inputCode(1, this.value)" name="account_id" id="account_id_1" required style="width:100%;">
                                                <option value="">Select Account</option>
                                                <?php
        										if($to_accounts){
        										foreach($to_accounts as $account){
                                        ...
                                        <!--<td class="span3">-->
                                        <!--    <input type="text" id="narration_1" name="narration[]" class="form-control text-left" tabindex="14"  placeholder="Paymet's nature and description" required>-->
                                        <!--</td>-->
                 ...
                 <!--                           <div class="tooltip1 input-group-append">-->
                                        ...
                                        <td class="span3">
                                           <input type="text" id="p_balance_1" name="p_balance[]" class="form-control text-center"tabindex="15" placeholder="0.00" readonly>
                                        </td>
                                        
                                        <td class="test">
                                            <input type="number" step="0.01" oninput="validity.valid||(value='');" name="amount[]" required=""  id="amount_1" class="form-control amount text-right"tabindex="16" onkeyup="calculateSum()" onchange="calculateSum()" placeholder="0.00" value="" min="0" required>
                                        </td>
                                        
                                        <td>
                                            <button class="btn btn-danger text-right red" type="button" value="Delete"  tabindex="17"onclick="deleteRow(this)" ><i class="fas fa-times"></i></button>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="total_amount" class="text-right form-control" name="total_amount" tabindex="-1" value="<?=$totalAmount;?>" readonly="readonly">
                                        </td>
                                        <td> 
                                        <button type="button" id="add_invoice_item" class="btn btn-success" name="add-invoice-item" tabindex="19" onclick="addRow()" <?php if(isset($edit)  && $edit != ""){ echo 'disabled';} ?>><i class="fa fa-plus"></i></button>
                                    </tr>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    <label for="date" class="col-sm-4 col-form-label">Post Status <i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-8" style="    margin-top: 7px;">
								        <div class="radio radio-info form-check-inline">
                                            <input type="radio" id="inlineRadio1" value="0" tabindex="20" name="post_status" <?php if(isset($edit)){ if($editData['post_status']==0){ echo 'checked';} }else{ echo 'checked'; } ?> >
                                            <label for="inlineRadio1"> Post </label>
                                        </div>
                                        <div class="radio radio-info form-check-inline">
                                            <input type="radio" id="inlineRadio2" value="1" tabindex="21" name="post_status" <?php if(isset($edit)){ if($editData['post_status']==1){ echo 'checked';} } ?>>
                                            <label for="inlineRadio2"> Unpost </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-8">
                                ...
                                <?php if(isset($edit)  && $edit != ""){ ?>
                                    ...
                                    <input type="submit" id="edit_vourcher" class="btn btn-successs"  name="edit-vourcher" value="Update F10" tabindex="22">
                                    <input type="hidden" name="edit-vourcher" value="1"/>
                                <?php }else{ ?>
                                    <input type="hidden" name="add-vourcher" value="1"/>
                                    <input type="submit" id="add_vourcher" class="btn btn-successs"  name="add-vourcher" value="Proceed F10" tabindex="22">
                                    <input type="reset"  class="btn btn-danger btn-large" name="reset" id="Reset" value="Reset F5" tabindex="23">
                                <?php } ?>
