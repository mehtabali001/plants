...
<table class="table table-borderless" style="width:100%;">
    <?php 
    $supplier = $this->db->query("SELECT * FROM tbl_suppliers WHERE accounts_id = '{$_GET['account_id']}'")->row_array();
    // $account_name=$this->db->query("SELECT * FROM tbl_coa WHERE head_code = '{$_GET['account_id']}'")->row()->head_name;
    ?>
    <tbody>
        <tr>
            ...
            <td>
                <div class="detail text-left" >
                    <span style="font-weight:bold;font-size:12px;">Type:</span>&nbsp;<span class="" style="font-size:12px;">Supplier Ledger</span><br>
                     <span style="font-weight:bold;font-size:12px;">Account Title:</span>&nbsp;<span class="" style="font-size:12px;"><?php echo $supplier['fld_company_name']; ?></span><br>
                     <span style="font-weight:bold;font-size:12px;">Account id:</span>&nbsp;<span class="" style="font-size:12px;"><?php echo $supplier['accounts_id']; ?></span><br>
                     <span style="font-weight:bold;font-size:12px;">Contact:</span>&nbsp;<span class="" style="font-size:12px;"><?php echo $supplier['fld_mobile_num']; ?></span><br>
                     <span style="font-weight:bold;font-size:12px;">Address:</span>&nbsp;<span class="" style="font-size:12px;"><?php echo $supplier['fld_city']; ?></span><br>
				     <span style="font-weight:bold;font-size:12px;">From:</span>&nbsp;<span class="" style="font-size:12px;"><?php echo $_GET['from_date']; ?></span><br>
                     <span style="font-weight:bold;font-size:12px;">To:</span>&nbsp;<span class="" style="font-size:12px;"><?php echo $_GET['to_date']; ?></span><br>
                </div>
            </td>
        </tr>
    </tbody>
	...
	<tbody class="ledgerRows" id="ledgerRows">
		 <?php if($ledger){
    		...
    		<tr class="search_filter">
    			<td colspan="8" style="padding-left: 24%;font-weight:bold;color:#000;"><?php echo $ledge['filter_text'];?></td>
            </tr>
				<tr>
				<td ><?php echo $i;?></td>
