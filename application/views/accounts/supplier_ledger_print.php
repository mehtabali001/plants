...
<?php 
    ...
    <div style="float:right;margin-top:2%;">
        <span style="font-weight:bold;">Type:</span>&nbsp;<span class="fromDate">Supplier Ledger</span><br>
        <span style="font-weight:bold;">Account Title:</span>&nbsp;<span class="fromDate">
        <?php $length = strlen($supplier['fld_company_name']);
        if($length > 25){
           $text= substr($supplier['fld_company_name'], 0, 20).'<br>'.substr($supplier['fld_company_name'], 20);
        }else{
            $text=$supplier['fld_company_name'];
        }
        echo $text;?>
        </span><br>
        <span style="font-weight:bold;">Account id:</span>&nbsp;<span class="fromDate"><?php echo $supplier['accounts_id']; ?></span><br>
        <span style="font-weight:bold;">Contact:</span>&nbsp;<span class="fromDate"><?php echo $supplier['fld_mobile_num']; ?></span><br>
        <span style="font-weight:bold;">Address:</span>&nbsp;<span class="fromDate"><?php echo $supplier['fld_city']; ?></span><br>
