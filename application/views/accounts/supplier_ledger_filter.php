		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom: 15px;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                     <? if(!empty($role_permissions) && in_array(240,$role_permissions)) { ?>
                    <a type="button" id="print_report" onclick="print_ledger('supplier_ledger_print');" class="btn btn-outline-primary print_report" name="" value="" disabled><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print</a>
				    <? } ?>
				    <? if(!empty($role_permissions) && in_array(241,$role_permissions)) { ?>
                    <a type="button" id="pdf_purchase_report" class="btn btn-outline-primary pdf_purchase_report" onclick="pdf_ledger('supplier_ledger_pdf');" name="" value="" disabled><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;PDF</a>
					<? } ?>
					<? if(!empty($role_permissions) && in_array(241,$role_permissions)) { ?>
...
<script>
    ...
    function downloadcsv(){
       ...
       var url="<?= base_url();?>/Accounts/supplier_ledger_filter_csv?"+formdata;
       window.open(url);
   }
</script>
