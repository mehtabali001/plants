                ...
                <img class="company-logo" src="<?=base_url()?>/assets/uploads/logo/<?=$settings['system_logo'];?>" style="height:70px;float:left;">
                                            ...
                                            <td>
                                                <div class="detail text-left" >
                                                    <span style="font-weight:bold;">Type:</span>&nbsp;<span class="" style="font-size:10px;">Profit and Loss Report</span><br>
                                                     <span style="font-weight:bold;">Showing Report As :</span>&nbsp;<span class="" style="font-size:10px;"><?php echo str_replace('_', ' ', $_GET['filter']); ?>, <?php if($_GET['filter_type']==1){echo 'Detailed';}else{echo 'Summary';} ?> </span><br>
...
<hr style="width:100%;">
		...
		<tr class="search_filter">
			<td colspan="14" style="padding-left: 24%;"><?php echo $sale['filter_text'];?></td>
		</tr>
				<?php
				$mtqty=0;
				$kgqty=0;
