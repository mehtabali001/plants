		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="<?= base_url();?>SaleRate" type="button" class="btn btn-primary btn-large"><i class='fas fa-user-plus'></i>&nbsp;Add Sale Rate</a>
                  <a href="<?= base_url();?>SaleRate/manage_salerateHistory" type="button" class="btn btn-outline-primary"><i class='fas fa-user-cog'></i>&nbsp;Manage Sales History</a>
                </div>&nbsp;&nbsp;
			</div>
			<h4 class="page-title">Sale Rate</h4>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="javascript:void(0);">Sale Rate</a></li>
				<li class="breadcrumb-item active">Add Sale Rate</li>
			</ol>
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        ...
                        <h4>Add Sale Rate</h4>
                             <form action="<?= base_url('SaleRate/addSalerate');?>" method="post">
                                 <div class="col-sm-12">
        							<h4 class="form-section"><i class="icon-eye6"></i> <div></div> <div class="ml3" style="float:right;color:#1ad1bc;display:none; font-size:11px;">Saved in Draft Automatically.</div></h4>
        						</div>
        						<hr>
                                <div class="row">
                            		<div class="col-md-2">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p style="color:#900; text-align: left;" >LAST SALE RATE ADDED: <?=$this->db->query("SELECT * FROM tbl_sales_rate ORDER BY date")->row()->date;?></p>
                                    </div>
                                </div>
                            </form>
	                <hr>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
							...
							<td class="sale">
							  <input type="number" style="width: 100%;height: 100%;background: #FFF;border: none;padding: 10px;" min=0 max=30 value="<?=$hist['sale'];?>"  id="sale_<?=$hist['id'];?>" <?php if($hist['category'] == 1 && $subcategory->weight != '11.8' && $subcategory->weight != '1000'){ ?> readonly <?php }else{  ?> onkeyup="updateValue('sale', <?=$hist['id'];?>, <?=$hist['category'];?>, <?=$hist['sub_category'];?>)" onblur="updateValue('sale', <?=$hist['id'];?>, <?=$hist['category'];?>, <?=$hist['sub_category'];?>)"  <?php } ?>>
							</td>
							</tr>
						<?php }}else { ?>
						<tr>
