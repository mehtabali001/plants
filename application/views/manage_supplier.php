		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Supplier/manage_Supplier" type="button" class="btn btn-primary btn-large"><i class="fa fa-eye"></i>&nbsp;View Suppliers</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable_tb" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										...
										<?php 
											...
											$updateby =	$this->Common_model->select_single_field('fld_username','tbl_users',array('fld_id'=>$supl['fld_updated_by']));
										?>
                                        <tr>
                                            <td><?= $supl['fld_supplier_code']."<br>";
                                    		    if($supl['fld_updated_by'] != 0){
                                    				echo '<span style="width: 170px; display: inline-block;color:#506ee4; font-size:10px;">Updated On: '.date("d-m-Y,h:i A",strtotime(@$supl['fld_updated_date'])).'</span>'."<br>";
											...
											<a data-toggle="modal" class="exampleModal" data-target="#exampleModal" data-content="<?php echo $supl['fld_id']; ?>" data-uri="<?= base_url('Supplier/delete/'.$supl['fld_id'].'')?>">
...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-header">
        <h5 class="modal-title mt-0" id="exampleModalLabel">Supplier</h5>
