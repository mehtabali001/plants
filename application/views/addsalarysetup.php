		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
				  <a href="<?= base_url();?>Payroll/addsalarysetup" type="button" class="btn btn-primary btn-large"><i class="fas fa-money-check-alt"></i></i>&nbsp;New Salary Setup</a>    
			...
			<!--<h4 class="page-title">+Salary Setup</h4>-->
			<!--<ol class="breadcrumb">-->
...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<form method="post" action="<?= base_url('Payroll/updatesalarysetup');?>">
			<div class="row">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-lg-offset-3">
                                    ...
                                    ?>
                                        <option value="<?php echo $emp->id;?>" data_set="<?=$emp->employee_code;?>" data_designation="<?=$designation;?>" data_plant="<?=$plant;?>" data_basicpay="<?=$emp->basic_pay;?>" data_medallow="<?=$emp->med_allow;?>" data_other="<?=$emp->other;?>" data_grosspay="<?=$emp->gross_pay;?>" data_eobi="<?=$emp->eobi;?>" data_social="<?=$emp->social_security;?>" data_tax="<?=$emp->salary_tax;?>" data_deduction="<?=$emp->t_deductions;?>" data_netpay="<?=$emp->net_payment;?>" data_bank_name="<?=$emp->bank_name;?>" data_account_no="<?=$emp->account_no;?>" data_total_advance_amount="<?=$emp->total_advance_amount;?>" data_return_advance_amount="<?=$emp->return_advance_amount;?>" data_loanpaid_type="<?=$emp->loanpaid_type;?>" data_pay_per_month="<?=$emp->pay_per_month;?>"><?php echo $emp->full_name;?></option>
                                    <?php } } ?>
                                    </select>
                                </div>
                                <!-- <p id="demo"></p>-->
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="employee_code" name="employee_code" type="text" class="form-control" placeholder="Emp-001" readonly>
                                </div>
                            </div><!--end form-group-->
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="plant" name="plant" type="text" class="form-control"  placeholder="Zstar" readonly>
                                </div>
                            </div><!--end form-group-->
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="designation" name="designation" type="text" class="form-control" placeholder="Manager" readonly>
                                </div>
                            </div><!--end form-group-->
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="account_no" name="account_no" type="text" placeholder="10010001" class="form-control">
                                </div>
                            </div><!--end form-group-->
                        </div>
                        ...
                        <div class="benifts" style="border: 1px solid #d5d7e5;padding: 10px;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="basic_pay" name="basic_pay" type="number" placeholder="0.00" class="form-control">
                                </div>
                            </div><!--end form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="medical_allowence" name="med_allow" type="number" placeholder="0.00" class="form-control">
                                </div>
                            </div><!--end form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="other" name="other" type="number" placeholder="0.00" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="gross_pay" name="gross_pay" type="number" class="form-control" placeholder="0.00" readonly>
                                </div>
                            </div><!--end form-group-->
                        ...
                        <div class="benifts" style="border: 1px solid #d5d7e5;padding: 10px;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="eobi" name="eobi" type="number" placeholder="0.00" class="form-control">
                                </div>
                            </div><!--end form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="social_security" name="social_security" type="number" placeholder="0.00" class="form-control">
                                </div>
                            </div><!--end form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="salary_tax" name="salary_tax" type="number" placeholder="0.00" class="form-control">
                                </div>
                            </div><!--end form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="total_advance_amount" name="total_advance_amount" type="number" class="form-control" placeholder="0.00" readonly>
                            ...
                            <div class="form-group row" id="row_dim">
                                ...
                                <div class="col-lg-7">
                                    <input id="pay_per_month" name="pay_per_month" type="number" placeholder="0.00" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input id="t_deductions" name="t_deductions" type="number" placeholder="0.00" class="form-control" readonly>
                                </div>
                            </div><!--end form-group-->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-lg-offset-3">
                                    <input id="net_payment" name="net_payment" type="number" class="form-control" placeholder="0.00" readonly>
                                </div>
                            </div>
                </div>    
				<div class="col-lg-6" style="margin-top: 5px;">
					<div class="mt-3">
						...
						<button type="submit" class="btn btn-successs" id="add_attendance_btn">Proceed F10</button>
					</div>
				</div>
				</div>
				</form>
