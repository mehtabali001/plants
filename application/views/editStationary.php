...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				<form method="post" action="<?= base_url('Common/editStationaryProcess');?>" id="edit_supplier">
				<div class="row">
				<div class="col-lg-12">
				...
				<div class="col-lg-6">
					<div class="mt-3">
						...
						<input type="text" class="form-control"  name="name" placeholder="e.g Groceries for kitchen" id="name" required value="<?= $stationary['name'];?>">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="mt-3">
						...
						<select class="select2 form-control mb-3 custom-select" id="fld_unit" name="fld_unit" required="required">
							...
							?>
								<option value="<?= $unit['fld_id'];?>" <? if($unit['fld_id'] == $stationary['fld_unit']){ echo "selected"; } ?>><?= $unit['fld_unit'];?></option>
							<?php }} ?>
						</select>
					</div>
				</div>
				<input type="hidden" name="id" value="<?= $stationary['id'];?>"/>
				<input type="hidden" name="orignal_name" value="<?= $stationary['name'];?>"/>
				<div class="col-lg-12">
					<div class="mt-3">
