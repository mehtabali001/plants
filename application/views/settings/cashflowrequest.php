		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Emailrequest/cashflowRequest" type="button" class="btn btn-primary btn-large"><i class="fas fa-sign-in-alt"></i>&nbsp;Cashflow Cron</a>
			...
			<!--<h4 class="page-title">Send Cashflow Request</h4>-->
			<!--<ol class="breadcrumb">-->
			<!--	<li class="breadcrumb-item"><a href="javascript:void(0);">Email Request</a></li>-->
			<!--	<li class="breadcrumb-item active">Cashflow Request</li>-->
			<!--</ol>-->
	...
	<div class="col-lg-12">
		<div class="card" style="overflow:auto;">
			<div class="card-body">
				...
				<form method="post" id="myform" action="<?= base_url('Emailrequest/sendcashflowrequest');?>" enctype="multipart/form-data">
				<div class="row">
				<div class="col-lg-12">
				<?php 
				...
				<?php
				 $qry = $this->db->query("SELECT * FROM tbl_cashflow_emailrequest");
				 if($qry->num_rows() > 0){
				 $qry2 = $this->db->query("SELECT * FROM tbl_cashflow_emailrequest where id = 1")->row();
				 }
				?>
				<div class="col-lg-12">
					<div class="mt-3">
						<label class="mb-2">Send To <i class="text-danger">*</i> <i style="font-size:10px;">(Below listed emails will receive cashflow  daily)</i></label>
				...
				<div class="col-lg-6">
				    <div class="mt-3">
                        <label for="example-time-input" class="mb-2">Cron Time <i style="font-size:10px;">(Listed emails will receive cash flow daily on below mentioned time)</i></label>
                ...
                <div class="col-lg-12">
                  <div class="mt-3">
				     <p class="link" style="color:red;">Note : Subject for Email , Title and Email body is created in Email Template section. For changes Please visit "<a href="https://zstar.mktechsol.com/Settings/editemail/7">https://zstar.mktechsol.com/Settings/editemail/7</a>"<br>If you want to in active this cron, please mark in active and proceed it to update.</p>
				  </div>
                </div>
				</div>
				</form>
			   ...
			   //$qryy = $this->db->query("SELECT * FROM tbl_stocks_emailrequest")->row_array();
				 $qryy = $this->Base_model->getAll('tbl_cashflow_emailrequest');
				 if($qryy){
					$i=1;
					foreach($qryy as $q){
				?>
