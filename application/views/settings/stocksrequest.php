		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Emailrequest/stocks" type="button" class="btn btn-primary btn-large"><i class="fas fa-sign-in-alt"></i>&nbsp;Stocks Cron</a>
			...
			<!--<h4 class="page-title">Send Stocks Request</h4>-->
			<!--<ol class="breadcrumb">-->
			<!--	<li class="breadcrumb-item"><a href="javascript:void(0);">Email Request</a></li>-->
			<!--	<li class="breadcrumb-item active">Stocks Request</li>-->
			<!--</ol>-->
	...
	<div class="col-lg-12">
		<div class="card" style="overflow:auto">
			<div class="card-body">
				...
				<form method="post" id="myform" action="<?= base_url('Emailrequest/sendstocksrequest');?>" enctype="multipart/form-data">
				<div class="row">
				<div class="col-lg-12">
				<?php 
				...
				<?php
				 $qry = $this->db->query("SELECT * FROM tbl_stocks_emailrequest");
				 if($qry->num_rows() > 0){
				 $qry2 = $this->db->query("SELECT * FROM tbl_stocks_emailrequest where id = 1")->row();
				 }
				?>
				<div class="col-lg-12">
					<div class="mt-3">
						<label class="mb-2">Send To <i class="text-danger">*</i> <i style="font-size:10px;">(Below listed emails will receive stocks daily.)</i></label>
				...
				<div class="col-lg-6">
				    <div class="mt-3">
                        <label for="example-time-input" class="mb-2">Cron Time <i style="font-size:10px;">(Listed emails will receive stock request daily on below mentioned time)</i></label>
				...
				<?php 
				 ...
				 $qryy = $this->Base_model->getAll('tbl_stocks_emailrequest');
				 if($qryy){
					$i=1;
					foreach($qryy as $q){
				?>
