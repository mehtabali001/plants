		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Navigations/manage_trash" type="button" class="btn btn-primary btn-large"><i class='fas fa-tags'></i>&nbsp;Trashed Navigations</a>
			...
			<!--<h4 class="page-title">View Trash</h4>-->
			<!--<ol class="breadcrumb">-->
			<!--	<li class="breadcrumb-item"><a href="javascript:void(0);">Others</a></li>-->
			<!--	<li class="breadcrumb-item active">Trashed Navigations</li>-->
			<!--</ol>-->
                                    ...
                                    <table id="datatable_tb" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
											<?php if($navigations){
												...
												$trashby =	$this->Common_model->select_single_field('fld_username','tbl_users',array('fld_id'=>$nav['fld_trash_by']));
											?>
											<tr>
												<td><?php echo date('d-m-Y',strtotime($nav['fld_created_date']));?></td>
												<td>
                    							<?php 
                                				 //echo 'KG-V-'.sprintf('%04d', $purch['fld_id']);
                                				 echo $trashby."<br>";
                                				 echo '<span style="width: 130px; display: inline-block;color:#506ee4; font-size:11px;">Date: '.date("d-m-Y",strtotime(@$nav['fld_trash_date'])).'</span>'."<br>";
                                				 echo '<span style="width: 130px; display: inline-block;color:#21d0c0; font-size:10px;">Time: '.date("h:i:s A",strtotime(@$nav['fld_trash_date'])).'</span>';
                                				?>
                    							</td>
												<!--<td><?php //echo sprintf('%04d', $nav['fld_id']);?></td>-->
												<td><?php echo $nav['location_from'];?></td>
												<td><?php echo $nav['location_to'];?></td>
												<!--<td><?php// echo $nav['fld_category'];?></td>-->
												<td style="font-size:12px;padding:3px;"><?php echo $nav['fld_shipment_from'];?></td>
												<!--<td><?php// echo $nav['fld_qty'];?></td>-->
												<!--<td><?//php echo $nav['fld_rate'];?></td>-->
												<td><?php echo $nav['fld_total_amount'];?></td>
												<td>
												...
												<a data-toggle="modal" class="exampleModal" data-target="#exampleModal" data-content="<?php echo $nav['fld_id']; ?>" data-uri="<?= base_url('Navigations/restore/'.$nav['fld_id'].'');?>">
		        <i style="font-size:16px;cursor:pointer;" class="fas fa-trash-restore" title="Restore"></i></a>
												<!--<a href="<?//= base_url('Navigations/restore/'.$nav['fld_id'].'');?>" onclick="return confirm('Are you sure you want to Restore this record.')">-->
												...
												<a data-toggle="modal" class="exampleModal2" data-target="#exampleModal2" data-content="<?php echo $nav['fld_id']; ?>" data-uri="<?= base_url('Navigations/deletepermanent/'.$nav['fld_id']);?>">
		        <i style="font-size:20px;cursor:pointer;" class="mdi mdi-delete-forever" title="Delete"></i></a>
												<!--<a href="<?//= base_url('Navigations/deletepermanent/'.$nav['fld_id']);?>" onclick="return confirm('Are you sure you want to delete this record.')">-->
