		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="<?= base_url();?>Employees" type="button" class="btn btn-primary btn-large"><i class='fas fa-user-plus'></i>&nbsp;New Employee</a>
...
<div class="row">
	...
	<form action="<?= base_url('Employees/add');?>" method="post" enctype="multipart/form-data">
		<fieldset aria-label="Step One" id="step-1">
            ...
            <div class="container">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="txtFirstNameBilling" class="col-sm-3 col-form-label">Employee ID <i class="text-danger">*</i></label>
                                <div class="col-sm-9">
                                    <input id="employee_code" name="employee_code" tabindex="1" type="text" class="form-control" readonly value="<?= $maxid;?>" required tabindex="1">
                                </div>
                        </div><!--end form-group-->
                    </div><!--end col-->
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="select2 form-control mb-3 custom-select" name="is_active" required tabindex="2">
                ...
                <!--<div class="row">-->
                    <div class="col-md-6" id="date_record">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control datepicker" type="text" name="date" value="" id="date" >
                            </div>
                        </div><!--end form-group-->
                    </div><!--end col-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7" id="type_div">
                                <select class="select2 form-control mb-3 custom-select" id="employee_type" name="employee_type">
                                    ...
                                    ?>
                                        <option value="<?php echo $emp_type->id;?>" <? if($emp_type->id == 2){ echo "selected"; } ?>><?php echo $emp_type->type_name;?></option>
                                    <?php } } ?>
                                </select>
                            </div>
                    ...
                    <div class="col-md-6" id="agree_type">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7" id="agreementtype_div">
                                <select class="select2 form-control mb-3 custom-select" id="agreement_type" name="agreement_type" required>
                                    ...
                                    ?>
                                        <option value="<?php echo $agree_type->id;?>" <? if($agree_type->id == 1){ echo "selected"; } ?>><?php echo $agree_type->agreement_type;?></option>
                                    <?php } } ?>
                                </select>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group row" id="target2">
                            ...
                            <div id="new_agreementtype_btn" class="col-sm-2">
                                    <button type="button" class="btn btn-gradient-primary" onClick="submitAgreementtype();">+</button>
                            </div>       
                        </div>
                    </div><!--end col-->
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7" id="department_div">
                                <select class="select2 form-control mb-3 custom-select" id="department" name="department"  required tabindex="3">
                ...
                <!--<div class="row">-->
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7" id="designation_div">
                                <select class="select2 form-control mb-3 custom-select" id="designation" name="designation" required tabindex="4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Plants <i class="text-danger">*</i></label>
                            <div class="col-sm-9">
                                <select class="select2 form-control mb-3 custom-select" id="plants" name="plants" required tabindex="5">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label" style="text-align: left;">COA</label>
                            <div class="col-sm-9">
                                <input type="text" id="coa" name="coa" class="form-control" placeholder="COA->Assets->Current Assets->Asset Employeed" tabindex="6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="full_name" name="full_name" type="text" class="form-control" required="required" tabindex="7" placeholder="Afzal">
                                </div>
                            </div><!--end form-group-->
                        </div><!--end col-->
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="f_hus_name" name="f_hus_name" type="text" class="form-control"  required tabindex="8" placeholder="Ahmed">
                                </div>
                            </div><!--end form-group-->
                        </div><!--end col-->
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="email" name="email" type="email" class="form-control"  required placeholder="abc@mail.com" tabindex="9">
                                </div>
                            </div><!--end form-group-->
                        </div><!--end col-->
                    <!--</div><!--end row-->
                    <!--<div class="row">-->
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="select2 form-control mb-3 custom-select" name="gender"  required tabindex="10">
                    ...
                    <!--<div class="row">-->
                        <div class="col-md-6" id="reli">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7" id="religion_div">
                                    ...
                                    ?>
                                        <option value="<?php echo $religion->id;?>" <? if($religion->id == 1){ echo "selected"; } ?>><?php echo $religion->religion_name;?></option>
                                    <?php } } ?>
                                    </select>
                                </div>
                                <div class="col-sm-2">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="txtAddress2Billing" class="col-sm-3 col-form-label">Cnic <i class="text-danger">*</i></label>
                                <div class="col-sm-9">
                                    <input  type="text"  data-inputmask="'mask': '99999-9999999-9'" class="form-control" placeholder="XXXXX-XXXXXXX-X"  name="cnic" required="" tabindex="11">
                                    <!--<input id="cnic" data-inputmask="'mask': '99999-9999999-9'"  placeholder="XXXXX-XXXXXXX-X"   name="cnic" type="text" class="form-control" required>-->
                                </div>                                                            
                            </div><!--end form-group-->
                        </div><!--end col-->
                    <!--</div><!--end row-->
                    <!--<div class="row">-->
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label  class="col-sm-3 col-form-label">Date of Birth <i class="text-danger">*</i></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control datepicker" name="dob" placeholder="Date of Birth" id="date-start" required tabindex="12">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Date of Joining <i class="text-danger">*</i></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control datepicker" name="joining_date" placeholder="Date of Joining" id="date-end" required tabindex="13">
                                </div>
                            </div>
                        </div><!--end col-->
                    <!--</div><!--end row-->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="txtLastNameBilling"  class="col-sm-3 col-form-label">Mobile No. <i class="text-danger">*</i></label>
                                <div class="col-sm-9">
                                    <input id="mobile_no" name="mobile_no" data-inputmask="'mask': '0399-99999999'"  type = "text" maxlength = "12"  class="form-control" placeholder="03XX-XXXXXXX" required tabindex="14">
                                </div>
                            </div><!--end form-group-->
                        </div><!--end col-->
                    <!--</div><!--end row-->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="account_no" name="account_no" type="text" class="form-control" placeholder="1234567890123" tabindex="15">
                                </div>
                            </div><!--end form-group-->
                        </div><!--end col-->
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7" id="bank_div">
                                    ...
                                    <select class="select2 form-control mb-3 custom-select" id="bank_name" name="bank_name" tabindex="16">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7" id="shifts_div">
                                    <select class="select2 form-control mb-3 custom-select" id="shift_group" name="shift_group" tabindex="17">
                                    ...
                                    ?>
                                        <option value="<?php echo $shif->id;?>" <? if($shif->id == 3){ echo "selected"; } ?>><?php echo $shif->shift_name;?></option>
                                    <?php } } ?>
                                    </select>
                                </div>
                ...
                <hr>
			<p>
				<button class="btn btn-gradient-primary btn-next" type="button" aria-controls="step-2" tabindex="18">Next</button>
			</p>
		</fieldset>
		...
		<fieldset aria-label="Step Two" id="step-2"><hr>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="select2 form-control mb-3 custom-select" name="degree_level" tabindex="19">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input class="form-control" type="text" name="degree_name"  placeholder="BS-IT" tabindex="20">
                            </div>
                        </div>
                    </div><!--end col-->
                    <div class="col-md-6" id="start_date">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control datepicker" type="text" name="degree_start_date" id="start">
                            </div>
                        </div><!--end form-group-->
                    </div><!--end col-->
                <!--</div><!--end row-->
                <!--<div class="row">-->
                    <div class="col-md-6" id="end_date">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control datepicker" type="text" name="degree_end_date" id="end">
                            </div>
                        </div><!--end form-group-->
                    </div><!--end col-->
                ...
                <!--<div class="row">-->
                    <div class="col-md-6" id="maj_sub">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="major_subjects" type="text" class="form-control" Placeholder="Software Engineering">
                            </div>                                                            
                        </div><!--end form-group-->
                    </div>
                    <div class="col-md-6" id="inst_name">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="txtLastNameBilling" name="institute_name"type="text" class="form-control" Placeholder="Comsats University">
                            </div>                                                            
                        </div><!--end form-group-->
                    </div><!--end col-->
                <!--</div><!--end row-->
            ...
            <p>
                <button class="btn btn-gradient-primary btn-prev" type="button" aria-controls="step-1" tabindex="21">Previous</button>
                <button class="btn btn-gradient-primary btn-next" type="button" aria-controls="step-3" tabindex="22">Next</button>
            </p>
        </fieldset>
        ...
        <hr>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="job_held" name="job_held" type="text" class="form-control" Placeholder="Pakistan State oil" tabindex="23">
                            </div>                                                            
                        </div><!--end form-group-->
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="pay_draw" name="pay_draw" type="text" class="form-control" Placeholder="Manager" tabindex="24">
                            </div>                                                            
                        </div><!--end form-group-->
                    </div> 
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="example-date-input" class="col-sm-3 col-form-label" name="start">Start Date</label>
                            <div class="col-sm-9">
                                <input class="form-control datepicker" type="text" name="job_start_date" id="start_job" tabindex="25">
                            </div>
                        </div><!--end form-group-->
                    </div><!--end col-->
                <!--</div>-->
                <!--<div class="row">                -->
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control datepicker" type="text" name="job_end_date" id="End_job" tabindex="26">
                            </div>
                        </div><!--end form-group-->
                    </div><!--end col-->
                </div>     
            ...
            <!--</p>-->
            <p>
                <button class="btn btn-default btn-prev" type="button" aria-controls="step-2" tabindex="27">Previous</button>&nbsp;
                <button class="btn btn-success" type="submit" id="add_employee" tabindex="28">Submit F10</button> &nbsp;
                <button class="btn btn-default btn-edit" type="button" id="edit" tabindex="29">Edit F6</button> &nbsp;
                <button class="btn btn-danger" type="reset" tabindex="30">Start Over F5</button>
            </p>
        </fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="basic_pay" name="basic_pay" type="number" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="Medical_Allowence" class="col-lg-3 col-form-label">Med. Allow.</label>
                                <div class="col-lg-9">
                                    <input id="medical_allowence" name="med_allow" type="number" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="other" name="other" type="number" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="gross_pay" name="gross_pay" type="number" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="eobi" name="eobi" type="number" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="social_security" name="social_security" type="number" class="form-control">
                                </div>
                            </div>>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="salary_tax" class="col-lg-3 col-form-label">Salary Tax</label>
                                <div class="col-lg-9">
                                    <input id="salary_tax" name="salary_tax" type="number" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="t_deductions" name="t_deductions" type="number" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="net_payment" name="net_payment" type="number" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
