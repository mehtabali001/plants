...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				<form method="post" action="<?= base_url('Common/edit_expensegroupProcess');?>" id="">
				<div class="row">
				<div class="col-lg-12">
				...
				<div class="col-lg-12">
					<div class="mt-3">
						...
						<input type="text" class="form-control"  name="expense_group_name" placeholder="Office expense" id="expense_group_name" required value="<?= $shift['expense_group_name'];?>">
					</div>                                   
				</div> 
