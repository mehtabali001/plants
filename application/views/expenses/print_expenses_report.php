                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="detail text-left" >
                                                     <span style="font-weight:bold;font-size:12px;">Type:</span>&nbsp;<span class="" style="font-size:12px;">Expense Report</span><br>
                                                     <span style="font-weight:bold;font-size:12px;">Showing Report As:</span>&nbsp;<span class="" style="font-size:12px;"> <?php echo str_replace('_', ' ', $_GET['filter']); ?>, <?php if($_GET['type']==1){echo 'Detailed';}else{echo 'Summary';} ?> </span><br>
                                                    <span style="font-weight:bold;font-size:12px;">From:</span>&nbsp;<span class="fromDate" style="font-size:12px;"></span><br>
                                                    <span style="font-weight:bold;font-size:12px;">To:</span>&nbsp;<span class="toDate" style="font-size:12px;"></span>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
...
<hr style="width:100%;">
		...
		<div class="bel">
		    <p style="position: sticky;font-style: italic; bottom: 0; color:#5d5d5d; font-size:10px;"><span style="font-weight:bold;">Note:</span> This is auto generated report on <?= date('d - M - Y'); ?>, <?= date('h:i A'); ?> by <?= $this->session->userdata('user_name'); ?> account  and requires signature from the approval authority.</p>
		    </div>
	...
	<script type="text/javascript">
		$(function(){
			...
			if (opener.$('#datatable_3tb').is(':visible')) {
