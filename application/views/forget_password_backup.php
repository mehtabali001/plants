									 ...
									 <?php echo form_open('Adminlogin/submit_forgot', array('id' => 'login','class'=>'form-horizontal auth-form my-4')) ?>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="email" class="form-control" id="email" placeholder="Enter Your Valid Email..." required>
                                            </div>                                    
                                        </div><!--end form-group--> 
                                        ...
                                        <div class="form-group mb-0 row">
                                            <div class="col-12 mt-2">
                                                <button class="btn btn-gradient-primary btn-round btn-block waves-effect waves-light" >Submit <i class="fas fa-sign-in-alt ml-1"></i></button>
                                            </div><!--end col--> 
                                        </div> <!--end form-group--> 
										<?php echo form_close() ?>										
                                    <!--</form>--><!--end form-->
