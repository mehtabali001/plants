                ...
                <table id="datatable2" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
						...
						<tr>
							...
							<td>
							<?php echo 'PO-'.sprintf('%04d', $purch['fld_id']);?>
							</td>
							<td>
							...
							<td>
							<?php 
							  $products = $this->db->query("select * from tbl_purchase_order_detail where fld_order_id = '".$purch['fld_id']."'")->result_array();
							...
							<a href="<?= base_url('Purchase/editOrder/'.$purch['fld_id'].'');?>">
							...
							<a data-toggle="modal" class="exampleModal" data-target="#exampleModal" data-content="<?php echo $purch['fld_id']; ?>" data-uri="<?= base_url('Purchase/deleteOrder/'.$purch['fld_id'].'');?>">
		        <i style="font-size:20px;cursor:pointer;" class="mdi mdi-delete-forever" title="Delete"></i></a>
							<!--<a href="<?//= base_url('Purchase/deleteOrder/'.$purch['fld_id'].'');?>" onclick="return confirm('Are you sure you want to delete this record.')">-->
...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-header">
        <h5 class="modal-title mt-0" id="exampleModalLabel">Purchase Order</h5>
