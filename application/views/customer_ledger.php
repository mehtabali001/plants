		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="<?= base_url();?>Customers" type="button" class="btn btn-outline-primary"><i class="fa fa-shopping-cart"></i>&nbsp;Add Customer</a>
                  <a href="<?= base_url();?>Customers/manage_Customers" type="button" class="btn btn-outline-primary"><i class="fa fa-vcard"></i>&nbsp;Manage Customer</a>
                  <a href="<?= base_url();?>Customers/customer_ledger" type="button" class="btn btn-primary btn-large"><i class="fa fa-vcard"></i>&nbsp;Customer Ledger</a>
                                ...
                                <div class="card-body">
                    				...
                    				<form id="customerLedgerfilter">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                    								<select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" name="customer" id="customer" required>
                    										<option selected="selected" value="0">Select Customers</option>
            												<?php
                												if($customers){
                												foreach($customers as $cus){
                												?>
                												<option value="<?= $cus['fld_id'];?>"><?= $cus['fld_customer_name'];?></option>
            												<?php }}?>
                    								</select>
                    							</div>
                    							<div class="col-sm-3">
                                            ...
                                            <button type="button" style="margin: 0px 10px;background-color: DodgerBlue;" id="print_customerledger_report" class="btn  print_report" name="" value=""><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print Report</button>
                                            <button type="button" style="margin: 0px 10px;" id="pdf_purchase_report" class="btn btn-gradient-pink pdf_customerledger_report" name="" value=""><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;Download PDF</button>
                                            <button type="button" style="margin: 0px 10px;" id="reset_filters" class="btn btn-danger" name="" value="" onclick="window.location.href='<?= base_url(); ?>Customers/customer_ledger'"><i class="fa fa-refresh" aria-hidden="true" ></i>&nbsp;Reset Flters</button>
                                        </form>
                    				</div>	
                    				<hr>
                    				<br>
