		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Common/manage_Category" type="button" class="btn btn-primary btn-large"><i class="fa fa-eye"></i>&nbsp;View Unit</a>
...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				<form method="post" action="<?= base_url('Common/editUnitProcess');?>"   id="edit_supplier">
				<div class="row">
				<div class="col-lg-12">
				...
				<div class="col-lg-6">
					...
					<div class="mt-3">
						...
						<input type="text" class="form-control"  name="fld_unit" id="fld_unit" required value="<?= $unit['fld_unit'];?>" placeholder="e.g M.T" pattern=".*\S+.*">
					</div>                                    
					                            
				</div> 
				<input type="hidden" name="fld_unit_id" value="<?= $unit['fld_id'];?>"/>
				<input type="hidden" name="orignal_unit" value="<?= $unit['fld_unit'];?>"/>
				<div class="col-lg-12">
					<div class="mt-3">
