                            ...
                            <div class="card-body" style="z-index:20;">
                                ...
                                <div class="px-3">
                                    ...
                                    <h4 class="text-muted">Session <?=$settings['financial_year'];?></h4>
                                     <p class="text-muted mb-0">Enter Your Email For Reset Password.</p>  
                                    ...
                                    <ul class="nav-border nav nav-pills" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active font-weight-semibold" data-toggle="tab" href="#LogIn_Tab" role="tab">Forgot Password</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">                                        
                                            ...
                                            <?php echo form_open('Adminlogin/submit_forgot', array('id' => 'login','class'=>'form-horizontal auth-form my-4')) ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="email" class="form-control" name="email" id="email" placeholder="Enter Your Valid Email..." required oninvalid="this.setCustomValidity('Invalid Email ')">
                                                    </div>                                    
                                                </div><!--end form-group--> 
                                                ...
                                                <div class="form-group mb-0 row">
                                                    <div class="col-12 mt-2">
                                                        <button class="btn btn-primary btn-round btn-block waves-effect waves-light login_in"  style="box-shadow: none;" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait...">Proceed<i class="fas fa-sign-in-alt ml-1"></i></button>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->                           
                                            <!--</form>-->
                                            <?php echo form_close() ?>
