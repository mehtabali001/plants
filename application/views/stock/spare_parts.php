...
<div class ="container">
    <div class="switch">
        <div class="btn-group " role="group" aria-label="Basic outlined example" style="width:100%;">
          <a href="<?= base_url();?>Stocks/parts" type="button" class="btn btn-primary btn-large" >&nbsp;Card View</a>
          <a href="<?= base_url();?>Stocks/tableview_parts" class="btn btn-outline-primary" >&nbsp;Table View</a>
        </div>
    </div>
    <br>
    <div class="switch">
    <div class="btn-group btn-group1" role="group" aria-label="Basic outlined example" style="margin: auto;display: table;">
       <a href="<?= base_url();?>Stocks" type="button" class="btn btn-outline-primary" style="border-top-left-radius: 25px; border-bottom-left-radius: 25px;"><i class="mdi mdi-fire"></i>&nbsp;LPG</a>
       <a href="<?= base_url();?>Stocks/empty_cylinders" class="btn btn-outline-primary"><i class="mdi mdi-gas-cylinder"></i>&nbsp;Empty Cylinder(s)</a>
       <a href="<?= base_url();?>Stocks/parts" class="btn btn-primary btn-large" style="border-top-right-radius: 25px; border-bottom-right-radius: 25px;"><i class="mdi mdi-accusoft"></i>&nbsp;Parts</a>
        </div>
     </div>
</div>
<div class="container">
           ...
           foreach($locations as $loc){
               $date = date('Y-m-d');
                if(isset($_POST['subcat_id']) && $_POST['subcat_id'] != 'all'){
                    $todaypurchase1= $this->db->query("SELECT SUM(b.fld_quantity) as fld_quantity FROM tbl_purchase as a, tbl_purchase_detail as b WHERE DATE(a.fld_purchase_date) = '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_purchase_id = a.fld_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->row()->fld_quantity+0; 
                    $pastpurchase1= $this->db->query("SELECT SUM(b.fld_quantity) as fld_quantity FROM tbl_purchase as a, tbl_purchase_detail as b WHERE DATE(a.fld_purchase_date) < '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_purchase_id = a.fld_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->row()->fld_quantity+0;
                    $todaysale1= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) = '$date' AND a.fld_location_from = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->row()->fld_quantity+0;
                    $pastsale1= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) < '$date' AND a.fld_location_from = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->row()->fld_quantity+0;
                  
                    $tsale = 0;
                    $psale = 0;
                    $todaypurchase2= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) = '$date' AND a.fld_location_to = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->row()->fld_quantity+0; 
                    $pastpurchase2= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) < '$date' AND a.fld_location_to = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->row()->fld_quantity+0;
                    $todaysale2= $this->db->query("SELECT sc.fld_subcategory, b.fld_quantity as fld_quantity FROM tbl_sale as a, tbl_sale_detail as b, tbl_subcategory as sc WHERE DATE(a.fld_sale_date) = '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_sale_id = a.fld_id AND sc.fld_subcid = b.fld_subproduct_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->result_array();
                    $pastsale2= $this->db->query("SELECT sc.fld_subcategory, b.fld_quantity as fld_quantity FROM tbl_sale as a, tbl_sale_detail as b, tbl_subcategory as sc WHERE DATE(a.fld_sale_date) < '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_sale_id = a.fld_id AND sc.fld_subcid = b.fld_subproduct_id AND b.fld_product_id = '4' AND b.fld_subproduct_id = '{$_POST['subcat_id']}'")->result_array();
                }else{
                    $todaypurchase1= $this->db->query("SELECT SUM(b.fld_quantity) as fld_quantity FROM tbl_purchase as a, tbl_purchase_detail as b WHERE DATE(a.fld_purchase_date) = '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_purchase_id = a.fld_id AND b.fld_product_id = '4'")->row()->fld_quantity+0; 
                    $pastpurchase1= $this->db->query("SELECT SUM(b.fld_quantity) as fld_quantity FROM tbl_purchase as a, tbl_purchase_detail as b WHERE DATE(a.fld_purchase_date) < '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_purchase_id = a.fld_id AND b.fld_product_id = '4'")->row()->fld_quantity+0;
                    $todaysale1= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) = '$date' AND a.fld_location_from = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4'")->row()->fld_quantity+0;
                    $pastsale1= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) < '$date' AND a.fld_location_from = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4'")->row()->fld_quantity+0;
                  
                    $tsale = 0;
                    $psale = 0;
                    $todaypurchase2= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) = '$date' AND a.fld_location_to = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4'")->row()->fld_quantity+0; 
                    $pastpurchase2= $this->db->query("SELECT SUM(b.fld_qty) as fld_quantity FROM tbl_navigations as a, tbl_navigations_details as b WHERE DATE(a.fld_created_date) < '$date' AND a.fld_location_to = '{$loc['fld_id']}' and b.fld_navigation_id = a.fld_id AND b.fld_product_id = '4'")->row()->fld_quantity+0;
                    $todaysale2= $this->db->query("SELECT sc.fld_subcategory, b.fld_quantity as fld_quantity FROM tbl_sale as a, tbl_sale_detail as b, tbl_subcategory as sc WHERE DATE(a.fld_sale_date) = '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_sale_id = a.fld_id AND sc.fld_subcid = b.fld_subproduct_id AND b.fld_product_id = '4'")->result_array();
                    $pastsale2= $this->db->query("SELECT sc.fld_subcategory, b.fld_quantity as fld_quantity FROM tbl_sale as a, tbl_sale_detail as b, tbl_subcategory as sc WHERE DATE(a.fld_sale_date) < '$date' AND a.fld_location_id = '{$loc['fld_id']}' AND b.fld_sale_id = a.fld_id AND sc.fld_subcid = b.fld_subproduct_id AND b.fld_product_id = '4'")->result_array();
                }
            ...
            <div class="category-card">
                ...
                <div class="content">
                    <ul>
                       ...
                       <li><a href="#">Opening Stock: <?=$openingstock;?></a></li>
                       <li><a href="#">Stock Receive: <?=$todaypurchase;?></a></li>
                       <li><a href="#">Today Sale: <?=$todaysale;?></a></li>
                       <li><a href="#">Closing Stock: <?=$closingstock;?></a></li>
                    </ul>
                </div>
             </div>
        </div>
