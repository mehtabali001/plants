...
<div class="container">
    <div class="switch">
        <div class="btn-group" role="group" aria-label="Basic outlined example" style="width:100%;">
          <a href="<?= base_url();?>Stocks" type="button" class="btn btn-outline-primary" >&nbsp;Card View</a>
          <a href="<?= base_url();?>Stocks/tableview_lpgempty" class="btn btn-primary btn-large" >&nbsp;Table View</a>
        </div>
    </div>
    <br>
    <div class="switch" style="margin-left:auto;margin-right:auto;margin-bottom:10px;display:table;">
        <div class="btn-group btn-group1" role="group" aria-label="Basic outlined example">
          ...
          <a href="<?= base_url();?>Stocks/tableview_lpgempty" class="btn  btn-primary btn-large"><i class="mdi mdi-gas-cylinder"></i>&nbsp;Empty Cylinder(s)</a>
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="btn-group float-right btnprint" role="group" style="margin-top:10px;margin-left: auto;margin-right:10px">
                  <a type="button"  id="print_report_lpgempty"  class="btn " name="" value="" style="border: 1px solid;"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;&nbsp;Print</a>
                  <a type="button" id="pdf_stock_report_lpgempty"  class="btn  " name="" value=""  style="border: 1px solid;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;&nbsp;PDF</a>
            </div>
        <div class="card-body">
