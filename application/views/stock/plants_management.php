...
<div class="container">
    <div class="switch">
        <div class="btn-group" role="group" aria-label="Basic outlined example" style="width:100%;">
          <a href="<?= base_url();?>Stocks" type="button" class="btn btn-primary btn-large" >&nbsp;Card View</a>
          <a href="<?= base_url();?>Stocks/tableviewlpg" class="btn btn-outline-primary" >&nbsp;Table View</a>
        </div>
    </div>
    <br>
    <div class="switch" style="margin-left:auto;margin-right:auto;display:table;">
        <div class="btn-group" role="group" aria-label="Basic outlined example" style="border-radius: 16px;">
          <a href="<?= base_url();?>Stocks" type="button" class="btn btn-primary btn-large" style="border-top-left-radius: 25px; border-bottom-left-radius: 25px;"><i class="mdi mdi-fire"></i>&nbsp;LPG</a>
