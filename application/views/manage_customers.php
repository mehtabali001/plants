		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom:15px;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Customers/manage_Customers" type="button" class="btn btn-primary btn-large"><i class="fa fa-eye"></i>&nbsp;View Customers</a>
                                    ...
                                    <table id="datatable_tb" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										...
										<?php if($customer){
											foreach($customer as $cust){
											    $updateby =	$this->Common_model->select_single_field('fld_username','tbl_users',array('fld_id'=>$cust['fld_updated_by']));
											?>
                                        <tr>
                                            <td>
                                            <?= $cust['fld_customer_code']."<br>";
                                    		    if($cust['fld_updated_by'] != 0){
                                    				echo '<span style="width: 170px; display: inline-block;color:#506ee4; font-size:10px;">Updated On: '.date("d-m-Y,h:i A",strtotime(@$cust['fld_updated_date'])).'</span>'."<br>";
                                            ...
                                            <td>
                                            <?php if($cust['fld_customer_type'] == 1){
												echo 'Local';
											}elseif($cust['fld_customer_type'] == 2){
												echo 'Importer';
											}else{
												echo '';
											} ?>
											...
											<a data-toggle="modal" class="exampleModal" data-target="#exampleModal" data-content="<?php echo $cust['fld_id']; ?>" data-uri="<?= base_url('Customers/delete/'.$cust['fld_id'].'')?>">
...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-header">
        <h5 class="modal-title mt-0" id="exampleModalLabel">Customer</h5>
