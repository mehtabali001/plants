		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="<?= base_url();?>Settings/add" type="button" class="btn btn-primary btn-large"><i class="fa fa-envelope"></i>&nbsp;+ Email Template</a>
...
<div class="row">
	<div class="card">
		<div class="card-body">
			<form method="post" action="<?= base_url('Settings/add');?>" id="myForm">
			<div class="row">
			<div class="col-lg-12">
			...
			<div class="col-lg-6">
				...
				<div class="mt-3">
					...
					<input type="text" class="form-control"  name="fld_email" id="fld_email" required placeholder="Welcome Email">
				</div>                                    
			...
			<div class="col-lg-6">
				...
				<div class="mt-3">
					...
					<input type="text" class="form-control"  name="fld_subject" id="fld_subject" required  placeholder="Welcome to MK Techsol">
				</div>                                    
				                            
			</div> 
			<div class="col-lg-12" style="margin-top:5vh;">
			    <textarea id="elm1" name="fld_email_body" ></textarea>
			</div>
			</div> 
			<div class="col-lg-12">
				<div class="mt-3">
