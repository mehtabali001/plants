		...
		<div class="card">
			<div class="card-body">
				<form method="post" action=""  id="edit_supplier">
				    <input type="hidden" name="editPartner" value="1" />
				<div class="col-lg-12">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<input type="text" class="form-control"  name="address" id="Address" value="<?php echo $edit_coa['address']; ?>" required placeholder="e.g OGDCL" pattern=".*\S+.*">
					</div>   
						<?php 
					...
					<div class="col-lg-6">
						...
						<input type="text" class="form-control" id="fld_coa" placeholder="<?php echo $parent_head_0; ?>-><?php echo $parent_head_1; ?>-><?php echo $parent_head_2; ?>" readonly>
					</div> 
					<div class="col-lg-12">
				...
				<div id="moreInfo" class="row" style="display: none;">
					...
					<div class="col-lg-6">
						...
						<input type="text" class="form-control"  name="contact" value="<?php echo $edit_coa['contact']; ?>" id="Contact" placeholder="e.g 051-1234567">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="mt-3">
