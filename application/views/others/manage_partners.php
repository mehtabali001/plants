		...
		<div class="page-title-box">
			<div class="float-right">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Others/manage_partners" type="button" class="btn btn-primary btn-large"><i class="fa fa-eye"></i>&nbsp;View Partners</a>
	                ...
	                <hr><?*/?>	
                                    <table id="datatable_tb" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$account['head_name']."<br>";
                                    		    if($account['fld_updated_by'] != 0){
                                    				echo '<span style="width: 150px; display: inline-block;color:#506ee4; font-size:10px;">Updated On: '.date("d-m-Y,h:i A",strtotime(@$account['fld_updated_date'])).'</span>'."<br>";
											...
											<a href="<?= base_url('Others/editPartner/'.$account['head_code'].'')?>">
											<i style="font-size:20px;cursor:pointer;" class="mdi mdi-square-edit-outline" title="Edit"></i></a>
											<? } ?>
											<!--<a href="<?//=base_url();?>Others/deleteP/<?=$account['head_code'];?>" onclick="return confirm('Are you sure you want to delete this record.')">-->
							    <!--                <i style="font-size:15px;cursor:pointer;" class="mdi mdi-delete-forever" title="Delete"></i>-->
							    <!--            </a>-->
											<a data-toggle="modal" class="exampleModal" data-target="#exampleModal" data-content="<?php echo $account['head_code']; ?>" data-uri="<?=base_url();?>Others/deleteP/<?=$account['head_code'];?>">
...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-header">
        <h5 class="modal-title mt-0" id="exampleModalLabel">Delete Partner</h5>
