...
<div class="container" style="padding:5px;">
    <div class="row">
      ...
      <hr>
        <span class="for"><br>
            <p style="font-weight:bold;font-size:16px;">Purchase Report</p>
            
             <div class="span12 centered">
				 <p style="border: 1px solid #000;width: 270px; "><span style="font-weight:bold;">From:</span>&nbsp;<span class="fromDate" style="font-size:8px;"><?php echo $_GET['form']; ?></span><br>
            <span style="font-weight:bold;">To:</span>&nbsp;<span class="toDate" style="font-size:8px;"><?php echo $_GET['to']; ?></span><br>
            </p>
								<br>
				</div>
        </span>
