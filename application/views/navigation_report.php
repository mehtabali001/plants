		...
		<div class="page-title-box">
			<div class="float-right" style="margin-bottom: 15px;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
                  ...
                  <a href="<?= base_url();?>Navigations/manage" type="button" class="btn btn-outline-primary btn-large"><i class='fa fa-eye'></i>&nbsp;View Navigations</a>
                  ...
                  <a href="<?= base_url();?>Navigations/navigationReport" type="button" class="btn btn-primary"><i class='fa fa-bar-chart'></i>&nbsp;Navigations Report</a>
                </div>
			</div>
			<!--<h4 class="page-title">Navigation Report</h4>-->
			<!--<ol class="breadcrumb">-->
			<!--	<li class="breadcrumb-item"><a href="javascript:void(0);">Reports</a></li>-->
			<!--	<li class="breadcrumb-item active">Navigation Report</li>-->
			<!--</ol>-->
	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<form id="navigationfilter">
                        <input type="hidden" name="filter_type" id="filter_type" value="1" />
						<? if(!empty($role_permissions) && in_array(274,$role_permissions)){ ?>
                        <div class="row">
						<div class="col-sm-12">
						  <div class="float-right" style="margin-bottom: 15px;">
                            <button type="button" id="currentday" class="btn btn-success waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(45 218 181 / 50%);" name="show-current-day" onclick="getNavigationFilterDataByDate('daily');"><i class="fa fa-line-chart" aria-hidden="true"></i>&nbsp;This Day</button>
                            <button type="button" id="currentweek" class="btn btn-purple waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(109 129 245 / 50%);" name="show-current-week" onclick="getNavigationFilterDataByDate('weekly');"><i class="fa fa-line-chart" aria-hidden="true"></i>&nbsp;This Week</button>
                            <button type="button" id="currentmonth" class="btn btn-secondary waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(65 203 216 / 50%) !important;" name="show-current-month" onclick="getNavigationFilterDataByDate('monthly');"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;This Month</button>
                            <button type="button" id="currentyear" class="btn btn-info waves-effect waves-light" style="box-shadow: 0 7px 14px 0 rgb(155 167 202 / 50%);" name="show-current-year" onclick="getNavigationFilterDataByDate('yearly');"><i class="fa fa-line-chart" aria-hidden="true"></i>&nbsp;This Year</button>
						   </div>
						</div>
						</div>
						<? } ?>
                        ...
                        <button type="button" id="show_report" class="btn btn-successs btn-large show_report" name="show-report" onclick="getnavigation();"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Proceed F10</button>
                        ...
                        <button type="button" class="btn btn-warning" id="advance_search" id="hide" disabled>Advance Search F8</button>
                        <button type="button" id="reset_filters" class="btn btn-danger" name="" value="" disabled onclick="window.location.href='<?= base_url(); ?>Navigations/navigationReport'"><i class="fa fa-refresh" aria-hidden="true" ></i>&nbsp;Reset F5</button>
                                                ...
                                                <div class="row">
                    								<div class="col-md-4">
                    									<select class="select2 form-control mb-3 custom-select" id="shipment" name="shipment" onchange="advanceSearch();">
            												...
            												<option value="<?= $ship['fld_shipment_from'];?>"><?= $ship['fld_shipment_from'];?></option>
            												<?php }?>
            											</select>
                    								</div>
                    								<div class="col-md-4">
...
<script>
     function downloadcsv(){
        ...
        var formdata=$('#navigationfilter').serialize();
       window.location.href="<?php echo base_url(); ?>Navigations/navigationReport_csv?"+formdata;
   }
</script>
