...
<body>
	<div class="container-fluid" style="margin-top:10px;">
                                  ...
                                  <div class="for" style="float:left;">
                                        <img class="company-logo" src="<?= base_url()?>assets/custom_elements/images/logoreport.png" style="height:80px;"></span><br>
                                  ...
                                  <div class="from" style="float:right; margin-top:0%;">
                                    ...
                                    <p><span style="font-weight:bold;">&nbsp;Voucher :</span>&nbsp;<span class=""><?= $purchase['fld_voucher_no'];?></span><br>
                                    <span style="font-weight:bold;">&nbsp;Billing Date :</span>&nbsp;  <?= date('d-m-y',strtotime($purchase['fld_purchase_date']));?><br>
                                    <span style="font-weight:bold;padding-left:0; margin-bottom:0 !important;">&nbsp;Account :</span>&nbsp; <?= explode('/', $purchase['fld_shipment'])[0].'/'. explode('/', $purchase['fld_shipment'])[1];?><br>
                                    <span style="font-weight:bold;">&nbsp;Shipment : </span><span class="fromDate"><?= $purchase['fld_shipment'];?></span><br>
				...
				<div class="row-fluid">
					<div class="span12">
						<table class="signature-fields" style="top:114px;">
							<thead>
								<tr>
