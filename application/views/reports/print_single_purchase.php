...
@media print {
    ...
    <div style="float:right;margin-top:2%;">
        <span style="font-weight:bold;font-size:14px;">&nbsp;Bill ID :</span>&nbsp;<span class="desc"><?= $purchase['fld_voucher_no'];?></span><br>
        <span style="font-weight:bold;font-size:14px;">&nbsp;Billing Date :</span>&nbsp;  <span class="desc"><?= date('d-m-y',strtotime($purchase['fld_purchase_date']));?></span><br>
        <span style="font-weight:bold;font-size:14px;padding-left:0; margin-bottom:0 !important;">&nbsp;Account :</span>&nbsp;<span class="desc"> <?= explode('/', $purchase['fld_shipment'])[0].'/'. explode('/', $purchase['fld_shipment'])[1];?></span><br>
        <span style="font-weight:bold;font-size:14px;">&nbsp;Shipment : </span><span class="desc"><?= $purchase['fld_shipment'];?></span><br>
    </div>
