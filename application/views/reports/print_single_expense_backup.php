							...
							<div class="span12">
                                  ...
                                  <span class="for" style="float:left;">
                                        <h3 class="">Billing From : Fast-Tech Solutions</h3><br>
                                         ...
                                         <p><span style="font-weight:bold;">Plant (Purchase For): </span><span class="fromDate"><?= $plantfor;?></span><br>
                                        <span style="font-weight:bold;">Voucher #</span>&nbsp;<span class="fromDate"><?= $expense['expense_voucher'];?></span><br>
                                        </p>
                                  </span>
                                  ...
                                  <div class="from" style="float:right; margin-top:0%;">
                                    ...
                                    <p><span style="font-weight:bold;padding-left:0; margin-bottom:0 !important;">&nbsp;Billing For :</span>&nbsp; <?= $plantfor;?><br>
