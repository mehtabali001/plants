	...
	<form action="<?= base_url('Employees/add');?>" method="post" enctype="multipart/form-data">
		<fieldset aria-label="Step One" id="step-1">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="txtFirstNameBilling" class="col-sm-3 col-form-label">Staff ID <i class="text-danger">*</i></label>
                                <div class="col-sm-9">
                ...
                <div class="row">
                    <button class="btn btn-gradient-primary " type="button" onclick="myFunction()" id="record" style="margin-left: auto;">show more</button>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <button class="btn btn-gradient-primary " type="button" onclick="myFunction1()" id="personal" style="margin-left: auto;">show more</button>
                    </div>
                </div><hr>
                ...
                <div class="container">
                    ...
                    <div class="row">
                    <button class="btn btn-gradient-primary " type="button" onclick="myFunction2()" id="contact" style="margin-left: auto;">show more</button>
                </div>
                </div><hr>
                <h4>Bank Details</h4>
                <div class="container">
		...
		<fieldset aria-label="Step Two" id="step-2"><hr>
            ...
            <div class="container">
                ...
                <div class="row">
                    <button class="btn btn-gradient-primary " type="button" onclick="myFunction3()" id="education" style="margin-left: auto;">show more</button>
                </div>
            </div><hr>
            <p>
...
$(function() {
	...
	function sum() {
	$("#gross_pay").val(Number.NaN($("#basic_pay").val()) + Number.NaN($("#medical_allowence").val())+ Number.NaN($("#conv_allow").val())+ Number.NaN($("#other").val()));
