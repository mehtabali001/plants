...
function imgCropLib($source_path,$source_image_name,$dest_name,$name_ext) {//support


    switch($name_ext) {
		case 'gif':
		$image = imagecreatefromgif($source_path.$source_image_name);
		break;
		case 'jpg':
		$image = imagecreatefromjpeg($source_path.$source_image_name);
		break;
		case 'JPG':
		$image = imagecreatefromjpeg($source_path.$source_image_name);
		break;
		...
		case 'png':
		$image = imagecreatefrompng($source_path.$source_image_name);
		break;
  ...
  $filename = $source_path.$dest_name.$source_image_name;
  $width = imagesx($image);
